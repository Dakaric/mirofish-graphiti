...
// Step State
const currentStep = ref(1) // 1: Graph-Aufbau, 2: Umgebungsaufbau, 3: Simulation starten, 4: Berichtsgenerierung, 5: Tiefen-Interaktion
...
const handleNextStep = (params = {}) => {
  if (currentStep.value < 5) {
    ...
    // Wenn von Step 2 zu Step 3 gewechselt wird, die Konfiguration der Simulationsrunden protokollieren
