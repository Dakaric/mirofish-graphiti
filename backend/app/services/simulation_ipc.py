...
2. Simulation script polls the commands directory, executes commands and writes responses to responses/
...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specific platform (optional)
                - "twitter": only interview on the Twitter platform
                - "reddit": only interview on the Reddit platform
                - None: in dual-platform simulations interview both platforms; in single-platform simulations interview that platform
            timeout: Timeout

        Returns:
            IPCResponse, with the result field containing the interview output
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
    ...
    def send_batch_interview(
        ...
        Returns:
            IPCResponse, with the result field containing all interview outputs
        """
