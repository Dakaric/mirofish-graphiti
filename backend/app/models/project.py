...
Persists project state on the server side to avoid passing large payloads between
front-end requests.
"""
...
class Project:
    ...
    # Graph info (populated after endpoint 2)
...
class ProjectManager:
    """Project manager - persistent storage and retrieval of projects."""
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Return the project extracted text path."""
